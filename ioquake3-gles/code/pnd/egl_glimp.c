...
#ifdef USER_DEFINE
	EGLint pAttr[] = {EGL_WIDTH, WINDOW_WIDTH, EGL_HEIGHT, WINDOW_HEIGHT, EGL_NONE};
#else
	EGLint pAttr[] = {EGL_WIDTH, 800, EGL_HEIGHT, 480, EGL_NONE};
#endif
...
void GLimp_Init(void)
{
	...
	pandora_driver_mode_x11 = 0; //cvarPndMode->value;
	...
	{
#ifdef USER_DEFINE
        	glConfig.vidWidth  = WINDOW_WIDTH;
		glConfig.vidHeight = WINDOW_HEIGHT;
#else
